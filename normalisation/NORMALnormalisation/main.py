...
parser.add_argument('-res', '--resolution', help='resolution (either 25 or 100).', default='100')

#args = parser.parse_args()
args = vars(parser.parse_args())
chromosome_nr = "chr%s" % args['chromosomenr']
res = args['resolution']
path = '/home/eu_plus_3/HiC/GM12878/'+res+'kb_resolution_intrachromosomal/'
...
HiCfilename=path+chromosome_nr+'_'+res+'kb.RAWobserved'
